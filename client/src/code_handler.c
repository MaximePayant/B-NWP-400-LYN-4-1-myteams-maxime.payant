...
{
    void (*list_func[])(const char *) = {&code_101, &code_102, &code_103,
    &code_104, &code_105, &code_106, &code_107, &code_108, &code_109, &code_110,
    &code_111, &code_112, &code_113, &code_114, &code_439, &code_440, &code_441,
    &code_442, &code_443, &code_444, NULL};
