...
static void teams_event(char **list_args)
{
    ...
    if (strcmp(list_args[0], "thread") == 0)
        client_event_thread_created(list_args[1], list_args[2], time(NULL),
        list_args[4], list_args[5]);
    if (strcmp(list_args[0], "reply") == 0)
        client_event_thread_reply_received(list_args[1], list_args[2],
